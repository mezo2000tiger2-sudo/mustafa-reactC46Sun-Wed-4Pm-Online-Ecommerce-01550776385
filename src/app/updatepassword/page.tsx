...
if(payload?.message == 'fail'){
  ...
  <div className="w-5/6  md:w-1/2 mx-auto p-5 bg-gray-100 rounded-lg overflow-hidden">
    <h2 className='text-green-600 font-bold text-2xl mb-2'>Update password :</h2>
    ...
    <Field data-invalid={fieldState.invalid}>
      ...
      <div className="relative">
              <Input
                ...
                placeholder="EX:mizo@123"
              />
              {chekCurrentPassword == 'password'? 
              <svg onClick={()=>{setchekCurrentPassword('text')}} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6 absolute right-3 top-1/2 -translate-y-1/2 cursor-pointer transition">
