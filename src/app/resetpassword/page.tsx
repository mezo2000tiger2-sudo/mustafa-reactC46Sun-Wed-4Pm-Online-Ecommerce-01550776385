...
import { resetPasswordFn } from '../_servecies/reset-password/resetPassword';
...
export default function forgetpassword() {
  ...
  const { data, mutate: resetPassword , isPending } = useMutation({
  mutationKey:['reset-passwors'],
...
async function submitForm(values:zod.infer<typeof forgetPasswordShema>){
  ...
  <div className="w-5/6  md:w-1/2 mx-auto p-5 bg-gray-100 rounded-lg overflow-hidden">
    <h2 className='text-green-600 font-bold text-2xl mb-2'>Reset password :</h2>
...
/>
    ...
    <Button type='submit' className='my-6 w-full'>{isPending? 
    <>
